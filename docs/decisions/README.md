...
| [0016](0016-benchmarks.md) | Benchmarks: precise metric definitions, the measured (Δauth, margin) pair replacing the spec's signed framing, and one deterministic regeneration command with hard gates | [#17](https://github.com/Sehaan-1/switchback/issues/17) | Accepted |
